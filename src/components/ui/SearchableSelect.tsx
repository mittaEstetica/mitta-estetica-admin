          ...
          <div className="p-2">
            <div className="relative">
              ...
              <input
                ...
                placeholder="Buscar..."
                className="w-full rounded-md border border-gray-200 py-1.5 pl-8 pr-3 text-sm focus:border-brand-400 focus:outline-none focus:ring-1 focus:ring-brand-400"
              />
            </div>
          </div>
